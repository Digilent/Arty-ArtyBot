...
################################################################
# This is a generated script based on design: artyBot
#
...
proc write_mig_file_artyBot_mig_7series_0_0 { str_mig_prj_filepath } {
...
# End of write_mig_file_artyBot_mig_7series_0_0()
...
CONFIG.PHASE {0.000} \
  ...
  # Create instance: MAXSONAR_Processor_0, and set properties
  set MAXSONAR_Processor_0 [ create_bd_cell -type ip -vlnv natinst.com:user:MAXSONAR_Processor:1.0 MAXSONAR_Processor_0 ]

  # Create instance: MotorSpeedPosition_0, and set properties
  set MotorSpeedPosition_0 [ create_bd_cell -type ip -vlnv natinst.com:user:MotorSpeedPosition:1.0 MotorSpeedPosition_0 ]
...
CONFIG.NUM_MI {8} \
  ...
  write_mig_file_artyBot_mig_7series_0_0 $str_mig_file_path
...
CONFIG.DOUT_WIDTH {1} \
  ...
  # Create instance: xlslice_m1_feedback, and set properties
  set xlslice_m1_feedback [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_m1_feedback ]
  set_property -dict [ list \
CONFIG.DIN_FROM {2} \
CONFIG.DIN_TO {2} \
CONFIG.DIN_WIDTH {4} \
...
CONFIG.DOUT_WIDTH {1} \
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M04_AXI [get_bd_intf_pins MotorSpeedPosition_0/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M05_AXI [get_bd_intf_pins MAXSONAR_Processor_0/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M06_AXI [get_bd_intf_pins PmodJSTK2_0/AXI_LITE_SPI] [get_bd_intf_pins microblaze_0_axi_periph/M06_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M07_AXI [get_bd_intf_pins PmodJSTK2_0/AXI_LITE_GPIO] [get_bd_intf_pins microblaze_0_axi_periph/M07_AXI]
  ...
  connect_bd_net -net axi_gpio_0_gpio2_io_t [get_bd_pins axi_gpio_0/gpio2_io_t] [get_bd_pins pmod_bridge_0/in_bottom_bus_T]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins xlslice_DIR1/Din]
  connect_bd_net -net axi_gpio_0_gpio_io_t [get_bd_pins axi_gpio_0/gpio_io_t] [get_bd_pins pmod_bridge_0/in_top_bus_T]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins mig_7series_0/clk_ref_i]
  connect_bd_net -net clk_wiz_0_clk_out3 [get_bd_pins PmodJSTK2_0/ext_spi_clk] [get_bd_pins clk_wiz_0/clk_out3]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins mig_7series_0/sys_clk_i]
  connect_bd_net -net microblaze_0_Clk_2 [get_bd_pins MAXSONAR_Processor_0/s00_axi_aclk] [get_bd_pins MotorSpeedPosition_0/s00_axi_aclk] [get_bd_pins PWM_0/pwm_axi_aclk] [get_bd_pins PmodJSTK2_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/M06_ACLK] [get_bd_pins microblaze_0_axi_periph/M07_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins rst_mig_7series_0_83M/slowest_sync_clk]
  ...
  connect_bd_net -net pmod_bridge_0_in_bottom_bus_I [get_bd_pins axi_gpio_0/gpio2_io_i] [get_bd_pins pmod_bridge_0/in_bottom_bus_I] [get_bd_pins xlslice_m2_feedback/Din]
  connect_bd_net -net pmod_bridge_0_in_top_bus_I [get_bd_pins axi_gpio_0/gpio_io_i] [get_bd_pins pmod_bridge_0/in_top_bus_I] [get_bd_pins xlslice_m1_feedback/Din]
  connect_bd_net -net pmod_bridge_1_in_top_bus_I [get_bd_pins pmod_bridge_1/in_top_bus_I] [get_bd_pins xlslice_0/Din]
  ...
  connect_bd_net -net rst_mig_7series_0_83M_peripheral_aresetn [get_bd_pins MAXSONAR_Processor_0/s00_axi_aresetn] [get_bd_pins MotorSpeedPosition_0/s00_axi_aresetn] [get_bd_pins PWM_0/pwm_axi_aresetn] [get_bd_pins PmodJSTK2_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/M05_ARESETN] [get_bd_pins microblaze_0_axi_periph/M06_ARESETN] [get_bd_pins microblaze_0_axi_periph/M07_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins mig_7series_0/aresetn] [get_bd_pins rst_mig_7series_0_83M/peripheral_aresetn]
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net xlconcat_0_top_row_O_dout [get_bd_pins pmod_bridge_0/in_top_bus_O] [get_bd_pins xlconcat_top_row_O/dout]
  connect_bd_net -net xlconcat_1_bottom_row_O_dout [get_bd_pins pmod_bridge_0/in_bottom_bus_O] [get_bd_pins xlconcat_bottom_row_O/dout]
  ...
  connect_bd_net -net xlconstant_1_dout [get_bd_pins pmod_bridge_1/in_bottom_bus_O] [get_bd_pins pmod_bridge_1/in_bottom_bus_T] [get_bd_pins pmod_bridge_1/in_top_bus_O] [get_bd_pins pmod_bridge_1/in_top_bus_T] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins xlconcat_top_row_O/In0] [get_bd_pins xlslice_EN1/Dout]
  connect_bd_net -net xlslice_0_Dout1 [get_bd_pins MAXSONAR_Processor_0/pwm_sig] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_EN2_Dout [get_bd_pins xlconcat_bottom_row_O/In0] [get_bd_pins xlslice_EN2/Dout]
  ...
  connect_bd_net -net xlslice_m1_feedback_Dout [get_bd_pins MotorSpeedPosition_0/m1_feedback] [get_bd_pins xlslice_m1_feedback/Dout]
  connect_bd_net -net xlslice_m2_feedback_Dout [get_bd_pins MotorSpeedPosition_0/m2_feedback] [get_bd_pins xlslice_m2_feedback/Dout]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x44A20000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs MAXSONAR_Processor_0/S00_AXI/S00_AXI_reg] SEG_MAXSONAR_Processor_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x44A10000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs MotorSpeedPosition_0/S00_AXI/S00_AXI_reg] SEG_MotorSpeedPosition_0_S00_AXI_reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x00010000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs PmodJSTK2_0/AXI_LITE_SPI/Reg0] SEG_PmodJSTK2_0_Reg0
  create_bd_addr_seg -range 0x00001000 -offset 0x00020000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs PmodJSTK2_0/AXI_LITE_GPIO/Reg0] SEG_PmodJSTK2_0_Reg01
...
#  -string -flagsOSRD
preplace port ddr3_sdram -pg 1 -y 1430 -defaultsOSRD
preplace port jb -pg 1 -y 140 -defaultsOSRD
preplace port jc -pg 1 -y 1920 -defaultsOSRD
preplace port sys_clock -pg 1 -y 1730 -defaultsOSRD
preplace port jd -pg 1 -y 1150 -defaultsOSRD
preplace port usb_uart -pg 1 -y 1000 -defaultsOSRD
preplace port led_4bits -pg 1 -y 900 -defaultsOSRD
preplace port reset -pg 1 -y 1630 -defaultsOSRD
preplace port dip_switches_4bits -pg 1 -y 880 -defaultsOSRD
preplace inst rst_mig_7series_0_83M -pg 1 -lvl 1 -y 1350 -defaultsOSRD
preplace inst xlslice_0 -pg 1 -lvl 2 -y 1830 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 4 -y 220 -defaultsOSRD
preplace inst mig_7series_0 -pg 1 -lvl 6 -y 1470 -defaultsOSRD
preplace inst xlconstant_1 -pg 1 -lvl 5 -y 1930 -defaultsOSRD
preplace inst MAXSONAR_Processor_0 -pg 1 -lvl 6 -y 1300 -defaultsOSRD
preplace inst xlslice_m2_feedback -pg 1 -lvl 2 -y 610 -defaultsOSRD
preplace inst xlconcat_bottom_row_O -pg 1 -lvl 5 -y 320 -defaultsOSRD
preplace inst microblaze_0_axi_periph -pg 1 -lvl 5 -y 890 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 6 -y 390 -defaultsOSRD
preplace inst pmod_bridge_0 -pg 1 -lvl 6 -y 140 -defaultsOSRD
preplace inst xlslice_DIR1 -pg 1 -lvl 4 -y 140 -defaultsOSRD
preplace inst MotorSpeedPosition_0 -pg 1 -lvl 6 -y 610 -defaultsOSRD
preplace inst pmod_bridge_1 -pg 1 -lvl 6 -y 1920 -defaultsOSRD
preplace inst xlslice_DIR2 -pg 1 -lvl 4 -y 380 -defaultsOSRD
preplace inst axi_gpio_1 -pg 1 -lvl 6 -y 890 -defaultsOSRD
preplace inst PWM_0 -pg 1 -lvl 6 -y 770 -defaultsOSRD
preplace inst mdm_1 -pg 1 -lvl 3 -y 1200 -defaultsOSRD
preplace inst xlslice_EN1 -pg 1 -lvl 4 -y 60 -defaultsOSRD
preplace inst xlslice_m1_feedback -pg 1 -lvl 2 -y 530 -defaultsOSRD
preplace inst xlslice_EN2 -pg 1 -lvl 4 -y 300 -defaultsOSRD
preplace inst axi_uartlite_0 -pg 1 -lvl 6 -y 1010 -defaultsOSRD
preplace inst microblaze_0 -pg 1 -lvl 4 -y 1200 -defaultsOSRD
preplace inst clk_wiz_0 -pg 1 -lvl 2 -y 1720 -defaultsOSRD
preplace inst xlconcat_top_row_O -pg 1 -lvl 5 -y 130 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 5 -y 1310 -defaultsOSRD
preplace inst microblaze_0_local_memory -pg 1 -lvl 5 -y 1530 -defaultsOSRD
preplace inst PmodJSTK2_0 -pg 1 -lvl 6 -y 1150 -defaultsOSRD
preplace netloc xlconstant_1_dout 1 5 1 1620
preplace netloc pmod_bridge_1_in_top_bus_I 1 1 5 370 1880 NJ 1880 NJ 1880 NJ 1880 NJ
preplace netloc pmod_bridge_0_in_bottom_bus_I 1 1 6 370 10 NJ 10 NJ 10 NJ 10 1610 10 2000
preplace netloc xlslice_DIR1_Dout 1 4 1 1280J
preplace netloc mig_7series_0_mmcm_locked 1 0 7 30 1610 NJ 1610 NJ 1610 NJ 1610 NJ 1610 NJ 1610 1960
preplace netloc microblaze_0_axi_periph_M04_AXI 1 5 1 1580
preplace netloc pmod_bridge_0_in_top_bus_I 1 1 6 380 450 NJ 450 NJ 450 NJ 450 1550 270 1960
preplace netloc PWM_0_pwm 1 3 4 760 440 NJ 440 1630J 700 1960
preplace netloc PmodJSTK2_0_Pmod_out 1 6 1 NJ
preplace netloc mig_7series_0_DDR3 1 6 1 NJ
preplace netloc axi_gpio_0_gpio2_io_t 1 5 2 1640 20 1990
preplace netloc microblaze_0_Clk 1 2 4 NJ 1690 NJ 1690 NJ 1690 1680
preplace netloc microblaze_0_axi_periph_M06_AXI 1 5 1 1570
preplace netloc microblaze_0_axi_periph_M03_AXI 1 5 1 1590
preplace netloc xlconcat_1_bottom_row_O_dout 1 5 1 1560
preplace netloc rst_mig_7series_0_83M_peripheral_aresetn 1 1 5 NJ 1390 NJ 1390 NJ 1390 1280 600 1610
preplace netloc pmod_bridge_0_Pmod_out 1 6 1 NJ
preplace netloc microblaze_0_axi_periph_M00_AXI 1 5 1 1560
preplace netloc axi_mem_intercon_M00_AXI 1 5 1 1560
preplace netloc microblaze_0_M_AXI_DP 1 4 1 1250
preplace netloc microblaze_0_M_AXI_DC 1 4 1 N
preplace netloc microblaze_0_ilmb_1 1 4 1 1230
preplace netloc xlslice_0_Dout1 1 2 4 NJ 1830 NJ 1830 NJ 1830 1660J
preplace netloc sys_clock_1 1 0 2 NJ 1730 NJ
preplace netloc xlslice_DIR2_Dout 1 4 1 1260J
preplace netloc microblaze_0_Clk_2 1 0 7 20 710 NJ 710 NJ 710 780 710 1260 630 1640 1380 1960
preplace netloc axi_gpio_1_GPIO2 1 6 1 NJ
preplace netloc microblaze_0_axi_periph_M05_AXI 1 5 1 1560
preplace netloc rst_mig_7series_0_83M_mb_reset 1 1 3 NJ 1310 NJ 1310 770
preplace netloc axi_gpio_0_gpio_io_o 1 3 4 770 510 NJ 510 NJ 510 1980
...
preplace netloc xlslice_m2_feedback_Dout 1 2 4 NJ 610 NJ 610 NJ 610 NJ
preplace netloc xlconcat_0_top_row_O_dout 1 5 1 N
preplace netloc pmod_bridge_1_Pmod_out 1 6 1 NJ
preplace netloc axi_uartlite_0_UART 1 6 1 NJ
preplace netloc clk_wiz_0_clk_out2 1 2 4 NJ 1710 NJ 1710 NJ 1710 1670
preplace netloc mig_7series_0_ui_clk_sync_rst 1 0 7 20 1620 NJ 1620 NJ 1620 NJ 1620 NJ 1620 NJ 1620 1970
preplace netloc microblaze_0_axi_periph_M07_AXI 1 5 1 1550
preplace netloc microblaze_0_axi_periph_M02_AXI 1 5 1 1570
preplace netloc microblaze_0_dlmb_1 1 4 1 1240
preplace netloc clk_wiz_0_clk_out3 1 2 4 N 1730 NJ 1730 NJ 1730 1650J
preplace netloc axi_gpio_0_gpio2_io_o 1 3 4 780 520 NJ 520 NJ 520 1960
preplace netloc xlslice_m1_feedback_Dout 1 2 4 NJ 530 NJ 530 NJ 530 1620J
preplace netloc axi_gpio_1_GPIO 1 6 1 NJ
preplace netloc microblaze_0_debug 1 3 1 N
preplace netloc xlslice_1_EN2_Dout 1 4 1 NJ
preplace netloc rst_mig_7series_0_83M_interconnect_aresetn 1 1 4 NJ 1370 NJ 1370 NJ 1370 1270
preplace netloc mdm_1_debug_sys_rst 1 0 4 30 1130 NJ 1130 NJ 1130 760
preplace netloc reset_1 1 0 6 NJ 1630 380 1630 NJ 1630 NJ 1630 NJ 1630 1640
preplace netloc axi_gpio_0_gpio_io_t 1 5 2 1650 260 1970
preplace netloc xlslice_0_Dout 1 4 1 1280J
preplace netloc rst_mig_7series_0_83M_bus_struct_reset 1 1 4 NJ 1330 NJ 1330 NJ 1330 1220
levelinfo -pg 1 0 210 470 660 1000 1420 1820 2020 -top 0 -bot 2070
",
}
